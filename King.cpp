...
void King::checkOptionsCapture( int t_x, int t_y, bool& play, Board* board ){
    // first = false;
    // int x = t_x + 1;
    // int y = t_y + 1;
    //
...
void King::checkOptionsMove( int x, int y, bool& play, Board* board ) {}

bool King::movePawn( int x, int y, Board* board ){
